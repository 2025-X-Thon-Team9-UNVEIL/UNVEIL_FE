...
export default function MeasureItem({ address, totalGrade, noiseGrade, safetyGrade }: MeasureItemProps) {
  return (
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex-1 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Txt className="text-lg text-Semi-Red">안전도 등급: {safetyGrade}</Txt>
          </div>
        </div>
      </div>
    </div>
