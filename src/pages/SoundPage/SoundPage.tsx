  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <header className="flex items-center p-4">
        ...
        <h1 className="ml-4 text-lg font-bold">소음 측정</h1>
      </header>

      <main className="flex flex-col items-center justify-center flex-1 px-6">
        {/* 안내 박스 */}
        <div className="bg-red-50 border border-red-100 rounded-xl p-4 mb-10 w-full text-center">
          <p className="text-red-500 font-bold mb-1">🔊 소음 측정 방법</p>
        ...
        {/* 위치 정보 */}
        <h2 className="text-2xl font-bold mb-2">장충동2가</h2>
          ...
          <div
            className={`rounded transition-all ${
              isRecording
                ...
                : 'w-14 h-14 bg-red-500 rounded-full' // 녹음 아이콘 (원)
            }`}
          />
        </button>
