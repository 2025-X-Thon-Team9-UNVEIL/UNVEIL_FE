 ...
 */
export default function Txt({ children, className, weight = 'semibold', ...props }: PropsWithChildren<Props>) {
  return (
    <span className={cn('text-Hana-Black', fontMap[weight], className)} {...props}>
      {children}
    </span>
  );
}
